  ...
  return (
    <button
      ...
      className={cn(
        ...
        'bottom-[calc(6.25rem+env(safe-area-inset-bottom))] left-3 md:bottom-6 md:left-[4.5rem] lg:left-[calc(13.5rem)] lg:right-auto',
        'hover:bg-bg-4 focus:outline-none focus-visible:ring-2 focus-visible:ring-white/35',
      )}
      onClick={openPrompt}
      aria-label="Download PLAYR app"
    >
      <Icon icon={Download01Icon} size={16} className="shrink-0" aria-hidden />
